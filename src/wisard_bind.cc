...
PYBIND11_MODULE(wisardpkg, m){
    ...
    py::class_<WisardWrapper>(m, "Wisard")
      ...
      .def("classify_with_rules", (py::list (WisardWrapper::*)(const std::vector<std::vector<int>>&)) &WisardWrapper::pyClassifyWithRules)
      .def("classify_with_rules", (py::list (WisardWrapper::*)(const DataSet&)) &WisardWrapper::pyClassifyWithRules)
      .def("add_rule", &WisardWrapper::add_rule, py::arg("label"), py::arg("variableIndexes"), py::arg("multipleRuleValues"), py::arg("alpha"), py::arg("base")=2, py::arg("ignoreZero")=false)
      .def("getMentalImages", &WisardWrapper::getMentalImages)
      .def("get_rams_info", &WisardWrapper::get_rams_info)
